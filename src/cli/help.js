...
Usage:
  ...
  vibedocs runtime resume [target] --gate ID [--task TEXT] [--report FILE] [--feature SLUG] [--semantic off|heuristic] [--changed path] [--write-drafts] [--format text|json] [--output FILE]
...
Commands:
  ...
  runtime resume    Resume a blocked runtime flow after a recorded human decision.
